...
static int aifs_page_mkwrite(struct vm_fault *vmf)
{
	 ...
	 * invocation of aifs_page_mkwrite could see a different
...
static ssize_t aifs_direct_IO(struct kiocb *iocb, struct iov_iter *iter)
{
	/*
...
const struct address_space_operations aifs_aops = {
	.direct_IO = aifs_direct_IO,
};

const struct vm_operations_struct aifs_vm_ops = {
	.fault		= aifs_fault,
	.page_mkwrite	= aifs_page_mkwrite,
};
